...
After the shared prerequisites in :doc:`../index` are in place, generate the
Zephyr remote domain by running ``gen_domain_dts`` for the target processor.
...
- For bare-metal usage, follow :doc:`../baremetal/index` after generating the remote DTS.
- For FreeRTOS builds, consult :doc:`../freertos/index`.
